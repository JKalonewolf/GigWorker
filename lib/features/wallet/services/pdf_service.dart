...
class PdfService {
  Future<void> generateStatement({
    ...
    // UPPERCASE Title for Professional Look
    final String reportTitle = isWeekly
        ? "WEEKLY STATEMENT"
        : "MONTHLY STATEMENT";

    // 2. FETCH ALL DATA (Then we filter locally to avoid empty database issues)
    ...
    // 4. FILTER by Date Range (Crucial Step!)
    // We remove any transaction older than our startDate
    ...
    // 6. Calculate Totals (Only for the filtered period)
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      // HERE IS THE FIX: Uses the variable 'reportTitle'
                      pw.Text(
                        reportTitle,
                        style: pw.TextStyle(
                          fontSize: 14,
              ...
              pw.Spacer(),
              pw.Footer(
                leading: pw.Text("Generated by GigBank App"),
